...
-- DropForeignKey
ALTER TABLE "checks" DROP CONSTRAINT "checks_monitorId_fkey";

-- DropForeignKey
ALTER TABLE "checks" DROP CONSTRAINT "checks_regionId_fkey";

-- DropForeignKey
ALTER TABLE "monitors" DROP CONSTRAINT "monitors_userId_fkey";
